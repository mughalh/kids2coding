...
import { Home, Gamepad2, Bot, User, ChevronLeft } from "lucide-react-native";
  ...
  return (
    <ScreenWrapper scrollable>
      ...
      <View style={styles.bottomNav}>
        ...
        >
          <Puzzle size={24} color={Colors.primary} />
          <AppText style={[styles.navLabel, { color: Colors.primary }]}>Puzzles</AppText>
        </TouchableOpacity>
